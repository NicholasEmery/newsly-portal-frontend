...
const SearchBtnIcon = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Here you can integrate with the global store or search route
  ...
  return (
    ...
    >
      <button
        ...
        aria-label={openSearchBar ? t("closeSearch") : t("openSearch")}
      >
        {openSearchBar ? (
      ...
      >
        <input
          ...
          onFocus={handleFocus}
          className={`bg-transparent w-full text-[clamp(0.775rem,0.8vw,1.1rem)] px-1 pl-2 text-black placeholder:text-neutral-400 placeholder:text-[clamp(0.775rem,0.7vw,1rem)] transition-all duration-500 ease-in-out`}
          aria-label={t("search")}
        />
        <button
          type="submit"
