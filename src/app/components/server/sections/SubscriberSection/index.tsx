...
const SubscriberSetion = async ({
  ...
  return (
    <Link href={resolvedNoticeHref}>
      <section className="group relative left-1/2 -translate-x-1/2 overflow-hidden cursor-pointer flex flex-col justify-end items-center w-[calc(100vw-80px)] max-w-[calc(100vw-80px)] h-150 py-10 text-white rounded-11xl shadow-inset-[inset_0_0_0_9999px_rgba(0,0,0,0.25)]">
        <div
